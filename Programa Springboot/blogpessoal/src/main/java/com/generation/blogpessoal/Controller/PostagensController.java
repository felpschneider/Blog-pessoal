...
public class PostagensController{
	...
	@PostMapping
	public ResponseEntity<Postagens> InserirPostagem(@RequestBody Postagens Postagem){
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(Postagem));
	}
	
	@PutMapping
	public ResponseEntity<Postagens> AtualizarPostagem(@RequestBody Postagens Postagem){
